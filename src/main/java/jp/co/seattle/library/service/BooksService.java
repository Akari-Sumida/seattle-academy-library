...
public class BooksService {
	...
	public BookDetailsInfo getBookInfo(int bookId) {
		String sql = "SELECT id, title, author, publisher, publish_date, isbn, description, thumbnail_name, thumbnail_url FROM books WHERE books.id = ? ORDER BY title ASC;";
	...
	public int registBook(BookDetailsInfo bookInfo) {
		...
		String sql = "INSERT INTO books(title,author,publisher,publish_date,thumbnail_name,thumnail_url,isbn,description,reg_date,upd_date) VALUES(?,?,?,?,?,?,?,?,now(),now()) RETURNING id;";
